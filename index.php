...
<html lang="en-us">
    <head>
    	<title>Welcome to Developer Mehedi Official Website</title>
    ...
    <body>
        <div class="content-block" id="header">
            <div id="overlay-1">
                <header id="site-header" class="clearfix">
                    <div class="pull-left">
                        <h1><a href="" style="font-weight:bold;">Developer Mehedi</a></h1>
                    </div>
                ...
                <div class="middle text-center clearfix">
                    <div class="container">
                        <h1 class="pro-name">Web Developer <br /><span style="color: #fff;" >Mehedi</span></h1>
            ...
            <div class="isotope portfolio-items">
                <div class="element-item grid">
                    <div class="effect-zoe">
                        ...
                        <figcaption>
                            <h2 class="hidden-xs">Developer <span>Mehedi</span></h2>
                            <p class="icon-links">
                                <a href="https://facebook.com/engr.mehedi.0/" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="https://twitter.com/Engr_mehedi_0/" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="https://www.instagram.com/mehedi01399/" target="_blank"><i class="fa fa-instagram"></i></a>
				<a href="https://www.linkedin.com/in/engrmehedi0/" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="https://github.com/mehedi01399/" target="_blank"><i class="fa fa-github"></i></a>
                                <a href="https://stackoverflow.com/users/12174682/md-mehedi-hasan/" target="_blank"><i class="fa fa-stack-overflow"></i></a>
                            </p>
                        </figcaption>
                    </div>
                </div>
                ...
                <div class="overlay">
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="numbersList">
                            ...
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Portfolio</h4>
                                <span id="number2" class="count2">22</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                                <h4> Hours of Work</h4>
                                <span id="number3"  class="count3">50</span>
                            </li>
                            <li class="col-md-2 col-sm-4 col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                        	<div class="owl-carousel">
								<div class="owl-item">
									<div style="margin-left:70px;" class="testimonial">
                                        <img alt="Client Photo" src="img/testimonial_31-190x190.jpg">
                                        <p>Hey Mehedi, Your work is  very good. Best of luck.</p>
								...
								<div class="owl-item">
									<div class="testimonial">
                                        ...
                                        <p>I'm realy serprised to your work. You already build my 2 website. </p>
								...
								<div class="owl-item">
									<div class="testimonial">
                                        ...
                                        <p>I'm very happy for your work . Cause you build my wordpress website.</p>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 wow animated fadeInRight">
                                    ...
                                    <div class="col-md-12">
                                        <div class="contact-info">
                                            <div class="clearfix">
                                                ...
                                                <p><strong> Address :</strong> Magura Sadar, Magura.
                                                </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                ...
                                                <p><strong> Mobile No :</strong> +8801791-236492 </p>
                                            </div>
                                            <div class="clearfix">
                                                <div class="rotated-icon">
                                                    <div class="sqaure-nebir"></div>
                                                ...
                                                <p>
                                                    <strong> Email :</strong> mehedi01399@gmail.com
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <ul class="social-box">
                                        <li><a class="facebook-icon" href="https://facebook.com/engr.mehedi.0/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                        <li><a class="twitter-icon" href="https://twitter.com/Engr_mehedi_0/" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                        <li><a class="instagram-icon" href="https://www.instagram.com/mehedi01399/"  target="_blank"><i class="fa fa-instagram"></i></a></li>
                                        <li><a class="linkedin-icon" href="https://www.linkedin.com/in/engrmehedi0/"  target="_blank"><i class="fa fa-linkedin"></i></a></li>
										<li><a class="github-icon" href="https://github.com/mehedi01399/"  target="_blank"><i class="fa fa-github"></i></a></li>
                                        <li><a class="stack-overflow-icon" href="https://stackoverflow.com/users/12174682/md-mehedi-hasan/"  target="_blank"><i class="fa fa-stack-overflow"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <footer id="site-footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="copyright">&copy; 2019 Developer Mehedi</div>
                    </div>
                    <div class="col-sm-6">
                        <div class="designed-by text-white">Designed By <a class="text-decoration-none" href="https://facebook.com/engr.mehedi.0/" target="_blank">Engr.Mehedi</a></div>
                    </div>
                </div>
            </div>
        </footer>	<!-- site-footer -->
